  ...
  module Key
    ...
    prepended do
      ...
      def expires_at_before_max_expiry_date
        ...
        errors.add(:key, message: 'has an invalid expiry date. Set a shorter lifetime for the key or contact the instance administrator.') if expires_at > created_at + ::Gitlab::CurrentSettings.max_ssh_key_lifetime.days
      end
    end
